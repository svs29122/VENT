...
static struct ParseRule rules[] = { 
   ...
   [TOKEN_SLL]          = {NULL                 , parseBinary     , LOGICAL_PREC},
   [TOKEN_SRL]          = {NULL                 , parseBinary     , LOGICAL_PREC},
   [TOKEN_SRA]          = {NULL                 , parseBinary     , LOGICAL_PREC},
   [TOKEN_ROL]          = {NULL                 , parseBinary     , LOGICAL_PREC},
   [TOKEN_ROR]          = {NULL                 , parseBinary     , LOGICAL_PREC},
   ...
   [TOKEN_REM]	        = {NULL                 , parseBinary     , MULTIPLY_PREC},
